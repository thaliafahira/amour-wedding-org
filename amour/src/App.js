...
const AppContent = () => {
  ...
  const handleGenerate = async () => {
    // ... rest of your handleGenerate code ...
    setLoading(true);
    setError("");
    setImageURL("");
    ...
    try {
      const response = await fetch("https://api.openai.com/v1/images/generations", {
        ...
        headers: {
          ...
          Authorization: `Bearer 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`,
        },
        body: JSON.stringify({
          prompt,
          n: 1,
